...
namespace galois
{
   ...
   class GaloisField
   {
      ...
      ~GaloisField();
       ...
       inline GFSymbol mul(const GFSymbol& a, const GFSymbol& b)
       {
            ...
            if ((a == 0) || (b == 0))
              ...
              return alpha_to[fastmod(index_of[a] + index_of[b])];
          #endif
       }
       ...
       inline GFSymbol div(const GFSymbol& a, const GFSymbol& b)
       {
            ...
            return alpha_to[fastmod(index_of[a] - index_of[b] + field_size)];
          #endif
       }
       ...
       inline GFSymbol exp(const GFSymbol& a, const int& n)
       {
            ...
            if (a != 0)
            {
               if (n < 0)
               {
                  ...
                  if (b == 0)
                    return 1;
                  return alpha_to[fastmod(index_of[a] * b)];
               }
               else if (n == 0)
                 return 1;
               else
                return alpha_to[fastmod(index_of[a] * n)];
            }
            else
              return 0;
          #endif
       ...
       inline GFSymbol inverse(const GFSymbol& val)
       {
          ...
          #else
            return alpha_to[fastmod(field_size - index_of[val])];
          #endif
       }
      ...
      private:
       ...
       void generateField(const unsigned int* pp);
